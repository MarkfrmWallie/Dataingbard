        ...
        <div className="button-7">
          <div className="overlap-group-container-6">
            <div className="overlap-group2-14">
              <div className="hard-no-4 valign-text-middle poppins-medium-white-16px">{hardNo}</div>
            </div>
            <div className="overlap-group1-22">
              <div className="set-me-up-4 valign-text-middle poppins-medium-white-16px">{setMeUp}</div>
            </div>
          </div>
          <Link to="/guy-pitch-3">
            <div className="group-1904">
              <div className="overlap-group-28">
                <div className="aaaand-4 valign-text-middle poppins-medium-white-16px">{aaaand}</div>
              </div>
            </div>
          </Link>
        </div>
